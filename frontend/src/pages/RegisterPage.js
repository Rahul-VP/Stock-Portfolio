...
function RegisterPage() {
  ...
  return (
    <Box sx={{
      ...
      background: `linear-gradient(rgba(25, 118, 210, 0.7), rgba(67, 160, 71, 0.7)), url('https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1500&q=80') center/cover no-repeat`,
    }}>
      <Card sx={{ maxWidth: 400, width: '100%', p: 2, boxShadow: 6 }}>
        <CardContent>
          <Typography variant="h5" fontWeight={700} color="primary" gutterBottom>Register</Typography>
